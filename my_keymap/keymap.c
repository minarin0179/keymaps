...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LCTL   , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                                        KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_INT1  ,
              KC_LALT,KC_LGUI,LSFT_T(KC_LNG2)     ,LT(1,KC_SPC),LALT_T(KC_LNG1),                  KC_BSPC ,LT(2,KC_ENT), _______  , _______  , KC_PSCR
  ),
  ...
  [3] = LAYOUT_universal(
    ...
    RGB_MOD  , RGB_HUI  , RGB_SAI  , RGB_VAD  , _______  , SCRL_DVI ,                                        RGB_M_X  , RGB_M_G  , RGB_M_T  , RGB_M_TW , _______  , _______  ,
    RGB_RMOD , RGB_HUD  , RGB_SAD  , RGB_VAI  , _______  , SCRL_DVD ,                                        CPI_D1K  , CPI_D100 , CPI_I100 , CPI_I1K  , _______  , KBC_SAVE ,
